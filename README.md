[![GoDoc](https://godoc.org/github.com/aoldershaw/eventsource?status.svg)](https://godoc.org/github.com/aoldershaw/eventsource) ![Travis CI](https://travis-ci.org/altairsix/eventsource.svg?branch=master) 
...
```
go get github.com/aoldershaw/eventsource/...
```
